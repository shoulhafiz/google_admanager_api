...
def get_report():
	...
	df.rename(columns={"Dimension.WEEK":"WEEK","Dimension.DEVICE_CATEGORY_NAME":"DEVICE_CATEGORY_NAME","Dimension.DEVICE_CATEGORY_ID":"DEVICE_CATEGORY_ID",
	...
	table_id = "admanager.Inventory_Device_Category_Week"
	...
	job_config.schema = [
		...
		bigquery.SchemaField("TOTAL_LINE_ITEM_LEVEL_ALL_REVENUE","FLOAT")]
